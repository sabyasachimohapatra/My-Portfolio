  ...
  useEffect(() => {
    const getMyProfile = async () => {
      const { data } = await axios.get(
        "https://my-portfolio-backend-u1um.onrender.com/api/v1/user/me/portfolio",
  ...
  return (
    <div className="w-full">
      ...
      md:text-[2.2rem] lg:text-[2.8rem] tracking-[2px] mb-4">
        Hey, I'm Sabyasachi Mohapatra
      </h1>
      <h1 className="text-tubeLight-effect overflow-x-hidden text-[1.3rem] 
      sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px]">
        <Typewriter
          words={["FULLSTACK DEVELOPER", "BTech CSE Student", "MERN STACK DEVELOPER", "FREELANCER"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={50}
