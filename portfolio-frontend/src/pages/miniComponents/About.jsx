      ...
      <div>
        <div className="grid md:grid-cols-2 my-8 sm:my-20 gap-14">
          ...
          <div className="flex justify-center flex-col tracking-[1px] text-xl gap-5">
            <p>
              My name is Sabyasachi Mohapatra. I will
              graduate in Software Engineering from BPUT around 2026. I work as
              a web developer and freelancer. My hobbies include watching
              movies, series, playing video games, and reading books.
            </p>
            <p>
              I have interests not only in technology but also in movies,
              series, video games, and readind books.
            </p>
          </div>
        </div>
